...
I. добавление нового прибора - POST-запрос по адресу localhost:8080/registry/appliances, в качестве тела запроса выступает JSON-файл с атрибутами прибора
II. добавление новой модели прибора - POST-запрос по адресу localhost:8080/{тип прибора}/{наименование линейки}/models, также телом выступает JSON файл, куда нужно вписать атрибуты модели.
